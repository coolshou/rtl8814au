...
MODULE_PARM_DESC(rtw_switch_usb_mode, " 0: doesn't switch, 1: switch from usb2.0 to usb 3.0 2: switch from usb3.0 to usb 2.0");
...
#ifdef CONFIG_RTW_NAPI
	#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 1, 0))//jimmy
